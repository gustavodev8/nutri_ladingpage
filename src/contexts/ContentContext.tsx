...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  services: {
    ...
    items: [
      ...
      { icon: "Dumbbell", title: "Nutrição Esportiva", desc: "Plano alimentar para maximizar sua performance, ganho de massa ou definição, com prescrição de treino inclusa nos pacotes." },
      { icon: "CalendarCheck", title: "Acompanhamento Contínuo", desc: "Encontros a cada 21 dias para avaliar progresso e ajustar estratégias. Resultados reais vêm da continuidade, não de uma única consulta." },
      { icon: "Apple", title: "Avaliação Física Completa", desc: "Bioimpedância, dobras subcutâneas, circunferências, densidade muscular e avaliação de pele para um diagnóstico detalhado do seu corpo." },
    ],
  },
  pricing: {
    ...
    plans: [
      {
        ...
        popular: false,
        whatsappMessage: "Olá! Tenho interesse na Consulta Online.",
      },
      {
        ...
        popular: false,
        whatsappMessage: "Olá! Tenho interesse na Consulta Clínica Presencial.",
      },
      {
        ...
        popular: false,
        whatsappMessage: "Olá! Tenho interesse no Protocolo 90 Dias.",
      },
      {
        ...
        popular: true,
        whatsappMessage: "Olá! Tenho interesse no Pacote Semestral.",
      },
    ],
  },
  schedule: {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "O que inclui a avaliação física completa?", a: "Utilizamos bioimpedância, dobras subcutâneas, medidas corporais, avaliação de densidade muscular, pele e circunferências para um diagnóstico completo — identificando gordura localizada, riscos cardíacos e equilíbrio muscular." },
      { q: "Aceita convênio?", a: "Não. Atendemos somente particular. Para proporcionar atenção e dedicação total a cada paciente, optamos por não trabalhar com planos de saúde. Nosso atendimento é 100% personalizado." },
  ...
  modalities: {
    ...
    onlineDesc: "Atendo pacientes de todo o Brasil e do exterior com a mesma qualidade do presencial. Consulta por videochamada, cardápio digital e acompanhamento completo onde você estiver.",
  ...
  loja: {
    ...
    plans: [
      ...
      },
      {
        ...
        desc: "9 encontros + equipe completa (nutri + psicólogo + personal) + 6 meses de acompanhamento",
        price: "R$ 2.800",
        priceAmount: 2800,
      ...
      },
      {
        ...
        desc: "20 encontros + plataforma de cursos gratuita + equipe completa + máxima transformação",
        price: "R$ 4.550",
        priceAmount: 4550,
        badge: "",
        popular: false,
