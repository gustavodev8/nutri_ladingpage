...
export const BUILT_IN_FOODS: FoodItem[] = [
  // Frutas
  {
    ...
    fiber: 6.3,
    household_measures: [
      { unit: "col. sopa", grams: 30 },
      { unit: "unidade média", grams: 200 },
    ],
  },
  {
    id: "fr-06",
    ...
    fat: 0.1,
    fiber: 2.0,
    household_measures: [{ unit: "unidade média", grams: 80 }],
  },
  ...
  // Cereais e derivados
  {
    ...
    fiber: 1.6,
    household_measures: [
      { unit: "col. sopa", grams: 25 },
      { unit: "xícara", grams: 150 },
    ],
  },
  {
    id: "ce-03",
    ...
    fiber: 9.1,
    household_measures: [
      { unit: "col. sopa", grams: 10 },
      { unit: "col. chá", grams: 3 },
    ],
  },
  {
    id: "ce-12",
    ...
    fat: 0.2,
    fiber: 1.6,
    household_measures: [{ unit: "col. sopa", grams: 15 }],
  },
  ...
  // Ovos e laticínios
  {
    ...
    carbs: 0.6,
    fat: 9.5,
    household_measures: [{ unit: "unidade média", grams: 50 }],
  },
  {
    id: "ov-16",
    name: "Manteiga",
    ...
    fat: 83.2,
    household_measures: [
      { unit: "col. sopa", grams: 12 },
      { unit: "col. chá", grams: 4 },
    ],
  },
  {
    id: "ov-15",
    ...
    carbs: 1.8,
    fat: 21.1,
    household_measures: [{ unit: "col. sopa", grams: 20 }],
  },
