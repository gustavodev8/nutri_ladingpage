...
const CTASection = () => {
  ...
  return (
    <section className="py-20 lg:py-28 bg-green-dark relative overflow-hidden">
      ...
      <div
        ref={ref}
        className={`container mx-auto px-4 relative z-10 text-center transition-[opacity,transform] duration-700 ease-smooth ${
      ...
      >
        <div className="max-w-2xl mx-auto space-y-6 md:space-y-8">
          ...
          <Button
            asChild
            size="lg"
            className="bg-accent text-accent-foreground hover:bg-accent/90 text-base md:text-lg px-7 md:px-10 py-5 md:py-7 shadow-xl"
          >
            <a
