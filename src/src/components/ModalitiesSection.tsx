    ...
    <section id="atendimento" className="py-20 lg:py-28 bg-card">
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Online */}
          <div className="rounded-3xl bg-gradient-to-br from-primary/5 to-primary/10 p-8 lg:p-10 space-y-6 border border-primary/10">
          ...
          {/* Presencial */}
          <div className="rounded-3xl bg-gradient-to-br from-accent/5 to-accent/10 p-8 lg:p-10 space-y-6 border border-accent/10">
